...
def abt_us():
    tk.messagebox.showinfo("Developed By","Saurabh Kabrawala")
def git_lnk():
    tk.messagebox.showinfo("GITHUB","https://github.com/N1C3official give LIKE and SHARE")      
...
def web():
   ...
   threshold()
background_image = tk.PhotoImage(file="D://College//Electronic_Toll_Collection//TOLL//img_name.png")   
tmi= background_image.subsample(1,2)
    
#thresholding function
def threshold():
    
    image1 = cv2.imread('D://College//Electronic_Toll_Collection//TOLL//img_name.png')
    img = cv2.cvtColor(image1, cv2.COLOR_BGR2GRAY) 
    thresh2 = cv2.adaptiveThreshold(img, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, 
                                          cv2.THRESH_BINARY, 199, 5) 
    #cv2.imshow('Adaptive Gaussian', thresh2) 
    cv2.imwrite('D://College//Electronic_Toll_Collection//TOLL//thres_img_name.png',thresh2)
    pytesseract.pytesseract.tesseract_cmd = r'C:\\Program Files\\Tesseract-OCR\\tesseract.exe'
    text = pytesseract.image_to_string('D://College//Electronic_Toll_Collection//TOLL//thres_img_name.png')
    pytext = ("hello")
    entry_var.set(text)
    print(pytext)
    

background_image2 = tk.PhotoImage(file="D://College//Electronic_Toll_Collection//TOLL//thres_img_name.png")
...
image2 = tk.PhotoImage(file="D://College//Electronic_Toll_Collection//TOLL//thres_img_name.png")
i2=image2.subsample(1,2)
image3 = tk.PhotoImage(file="D://College//Electronic_Toll_Collection//TOLL//img_name.png")
